...
pub fn encrypt_aes(data: &[u8], key: &[u8], iv: &[u8]) -> Result<Vec<u8>, SymmetricCipherError> {
...
pub fn decrypt_aes(data: &[u8], key: &[u8], iv: &[u8], size: usize) -> Result<Vec<u8>, SymmetricCipherError> {
