...
mod tests {
    ...
    fn it_makes_a_genesis_block_with_txs() {
        ...
        match genesis_block.get_meta() {
            Ok(_) => panic!("No meta information was supplied, but genesis block has meta information!"),
            Err(_) => {}
        }
    ...
    fn create_genesis_header() -> GenesisBlockHeader {
        // Set up header
    ...
    fn create_genesis_txs() -> Vec<GenesisBlockTx> {
        ...
        let genesis_tx_1 = GenesisSignedTx(tx_1);
        ...
        let genesis_tx_2 = GenesisSignedTx(tx_2);
        ...
        let genesis_tx_3 = GenesisSignedTx(tx_3);
        ...
        let genesis_tx_4 = GenesisSignedTx(tx_4);
        ...
        let genesis_tx_5 = GenesisSignedTx(tx_5);
        ...
        let genesis_tx_6 = GenesisSignedTx(tx_6);

        vec![genesis_tx_1, genesis_tx_2, genesis_tx_3, genesis_tx_4, genesis_tx_5, genesis_tx_6]
    }

    fn create_expected_genesis_encoding() -> Vec<u8> {
        vec![10,84,18,32,63,181,253,151,156,233,
            72,189,81,168,225,146,117,176,187,0,83,83,31,27,171,129,202,
            194,240,38,156,91,131,127,207,151,26,32,121,132,139,154,165,
            229,182,152,126,204,58,142,150,220,236,119,144,1,181,107,19,
            130,67,220,241,192,46,94,69,215,134,11,33,0,0,0,0,0,0,0,0,40,
            168,184,239,233,139,44,18,100,18,20,11,181,71,187,17,26,124,
            178,99,162,96,88,212,122,136,90,16,252,254,235,24,128,128,
            160,246,244,172,219,224,27,50,64,22,221,209,1,153,187,59,
            100,249,224,81,229,6,89,230,150,104,199,229,7,191,94,31,116,
            224,83,41,58,104,35,204,189,96,77,86,99,69,243,237,35,106,
            215,176,110,113,85,133,62,69,176,245,74,80,40,164,234,107,
            132,100,135,195,32,76,158,56,1,18,100,18,20,20,172,52,145,
            135,93,229,13,193,97,80,104,183,138,132,87,177,224,233,120,
            24,128,128,168,236,133,175,209,177,1,50,64,189,36,210,45,239,
            228,233,146,171,234,170,126,142,158,221,102,7,58,121,80,106,
            207,12,105,254,81,148,142,43,11,95,225,114,152,212,239,105,
            128,115,242,243,71,57,227,161,132,226,223,6,219,4,24,167,103,
            233,89,0,178,229,199,229,237,214,232,56,0,18,100,18,20,74,92,
            52,70,84,37,197,115,110,79,0,154,9,198,192,6,200,12,132,127,
            24,128,128,200,157,157,235,150,248,6,50,64,8,106,101,224,229,
            144,115,64,238,176,220,45,192,68,110,22,152,116,80,142,140,194,
            87,181,89,105,7,178,116,88,132,64,93,221,2,101,38,212,119,41,
            233,180,120,15,141,3,22,76,121,31,156,41,67,220,0,255,255,129,
            128,130,38,111,188,190,56,0,18,100,18,20,79,164,22,41,92,131,
            196,210,126,157,6,109,177,113,128,7,16,121,88,180,24,128,128,
            200,157,157,235,150,248,6,50,64,216,216,182,240,69,245,211,112,
            118,195,196,166,109,0,39,224,75,99,37,58,63,236,142,1,194,33,186,
            55,3,134,255,249,88,117,48,29,208,169,54,108,80,250,110,196,
            252,98,38,130,202,47,68,195,150,254,230,226,96,76,222,104,235,
            63,140,160,56,1,18,100,18,20,100,122,82,165,32,27,125,117,206,
            33,252,177,254,17,2,172,179,165,145,12,24,128,128,160,177,151,
            188,197,198,5,50,64,100,74,23,91,232,118,63,48,190,221,108,193,
            208,65,69,9,23,186,93,187,13,243,54,51,49,144,127,148,41,36,138,
            174,60,114,62,139,193,225,72,241,31,26,186,189,155,145,185,217,135,
            255,158,227,168,225,62,17,34,246,227,47,80,90,195,93,56,1,18,100,
            18,20,193,2,252,220,116,178,175,175,186,175,179,5,219,15,64,216,8,
            88,8,32,24,128,128,200,157,157,235,150,248,6,50,64,128,85,24,160,
            100,145,206,75,9,170,203,75,122,52,207,109,100,133,252,204,84,3,
            236,158,38,195,33,100,12,112,129,205,104,206,252,101,101,196,190,
            231,190,129,57,29,166,137,35,236,58,27,190,228,14,123,55,148,247,
            92,199,22,238,89,6,152,56,0]
    }
}