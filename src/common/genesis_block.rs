...
struct GenesisBlock(Block<GenesisHeader, GenesisSignedTx>);

impl Deref for GenesisBlock {
    type Target = Block<GenesisHeader, GenesisSignedTx>;
    fn deref(&self) -> &Block<GenesisHeader, GenesisSignedTx> {
        &self.0
    }
}
