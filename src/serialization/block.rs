...
pub struct ExodusBlock {
    // message fields
    pub header: ::protobuf::SingularPtrField<super::blockHeader::GenesisHeader>,
    pub txs: ::protobuf::RepeatedField<super::tx::ExodusTx>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl ExodusBlock {
    ...
    // Param is passed by value, moved
    pub fn set_txs(&mut self, v: ::protobuf::RepeatedField<super::tx::ExodusTx>) {
        self.txs = v;
    }

    // Mutable pointer to the field.
    pub fn mut_txs(&mut self) -> &mut ::protobuf::RepeatedField<super::tx::ExodusTx> {
        &mut self.txs
    }

    // Take field
    pub fn take_txs(&mut self) -> ::protobuf::RepeatedField<super::tx::ExodusTx> {
        ::std::mem::replace(&mut self.txs, ::protobuf::RepeatedField::new())
    }

    pub fn get_txs(&self) -> &[super::tx::ExodusTx] {
        &self.txs
    }
}

impl ::protobuf::Message for ExodusBlock {
    fn is_initialized(&self) -> bool {
        for v in &self.header {
            if !v.is_initialized() {
                return false;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::blockHeader::GenesisHeader>>(
                    "header",
                    |m: &ExodusBlock| { &m.header },
                    |m: &mut ExodusBlock| { &mut m.header },
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<super::tx::ExodusTx>>(
                    "txs",
                    |m: &ExodusBlock| { &m.txs },
                    |m: &mut ExodusBlock| { &mut m.txs },
                ));
                ::protobuf::reflect::MessageDescriptor::new::<ExodusBlock>(
                    "ExodusBlock",
                    fields,
                    file_descriptor_proto()
                )
    ...
    fn default_instance() -> &'static ExodusBlock {
        static mut instance: ::protobuf::lazy::Lazy<ExodusBlock> = ::protobuf::lazy::Lazy {
            lock: ::protobuf::lazy::ONCE_INIT,
            ptr: 0 as *const ExodusBlock,
        };
        unsafe {
            instance.get(ExodusBlock::new)
        }
    }
}

impl ::protobuf::Clear for ExodusBlock {
    fn clear(&mut self) {
        self.clear_header();
        self.clear_txs();
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for ExodusBlock {
    fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for ExodusBlock {
    fn as_ref(&self) -> ::protobuf::reflect::ProtobufValueRef {
        ::protobuf::reflect::ProtobufValueRef::Message(self)
    }
}
